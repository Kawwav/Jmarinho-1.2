    ...
    <>
      <footer className="footer" translate="no">
        <div className="footer__inner">
          ...
          <nav className="footer__nav" aria-label="Menu rodapé">
          ...
          <div className="footer__socials">
            <a
              ...
              href="https://www.instagram.com/jmarinhoimoveis/"
              target="_blank"
      ...
      <ModalPrivacidade isOpen={modalAberto} onClose={() => setModalAberto(false)} />
    </>
  )
}
